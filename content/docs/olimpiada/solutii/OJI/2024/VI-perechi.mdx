...
Cerința 1: Pentru 27 de puncte, se citesc numerele din fișierul de intrare într-un vector, se parcurg elementele vectorului, iar pentru fiecare element aflat pe poziția $$i$$, cu $$1 \leq i \leq n - 1$$, se verifică toate elementele aflate pe pozițiile $$j$$, cu $$i + 1 \leq j \leq n$$, numărându-se toate elementele care sunt egale cu oglinditul lui $$a\_i$$ și formează o pereche oglindită cu $$a\_i$$. Complexitatea algoritmului este: $$\mathcal{O}(n^2)$$.
