...
```cpp
/*
Mai intai se afla ultima cifra nenula pentru cerinta 1. Apoi, e simplu de aflat
suma ultimelor valori conform enuntului

Pentru cerinta 2, trebuie aflat numarul de grupe folosind sume gauss si apoi
simulam suma fiecarei grupe
*/
