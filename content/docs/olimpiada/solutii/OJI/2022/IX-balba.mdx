...
int main() {
    ...
    if (c == 1) {
        ...
        // group all chars w/ even frequency and add the biggest odd in the
        // middle
        string ans = s;
        ...
        string finalans = ans;
        if (ans2.size() > finalans.size()
            || (ans2.size() == finalans.size() && ans2 > finalans)) {
            finalans = ans2;
        }
        if (ans3.size() > finalans.size()
            || (ans3.size() == finalans.size() && ans3 > finalans)) {
            finalans = ans3;
        }
            ...
            if (fr2[digit]) {
                ...
                for (int i = 0; i + 1 < (int)variant.size(); i++) {
                    if (fr2[variant[i] - '0']) {
                        ...
                        if (anss.size() > finalans.size()
                            || (anss.size() == finalans.size()
                                && anss > finalans)) {
                            finalans = anss;
                        }
                        break;
