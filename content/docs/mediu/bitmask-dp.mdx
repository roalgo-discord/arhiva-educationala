---
id: bitmask-dp
title: Dinamică pe stări exponențiale (bitmask DP)
authors: [stefdasca]
prerequisites:
  - intro-dp
  - bitwise-ops
...
În primul rând, pentru a putea folosi această tehnică, trebuie să ne reamintim câteva concepte învățate de la operațiile pe biți, cele mai importante fiind submulțimile și măștile pe biți. Pentru mai multe detalii, puteți citi [aici](./intro-combinatorics.mdx#submultimi).
...
## Problema teamwork
<ProblemPreview url="https://www.pbinfo.ro/probleme/1230/teamwork" />
...
Soluția va avea complexitate $$\mathcal{O}(2^n \cdot n)$$, fiind suficient de bună pentru problema dată.
...
<ProblemPreview url="https://cses.fi/problemset/task/1653" />
...
Complexitatea va fi la fel ca la problema precedentă, $$\mathcal{O}(2^n \cdot n)$$, fiind suficient de bună pentru cerințele problemei.
...
<ProblemPreview url="https://cses.fi/problemset/task/1690" />
