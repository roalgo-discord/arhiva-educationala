---
id: ad-hoc
title: Abordarea problemelor ad-hoc
authors: [stefdasca]
tags:
  - probleme
  - meta
...
<Callout type="info">
  Soluția acestei probleme este explicată în arhiva noastră [aici](../usor/simulating-solution.mdx#problema-exemplu-asort-baraj-2016-juniori).
</Callout>
...
## Problema Yinyang
<ProblemPreview url="https://kilonova.ro/problems/650" />
...
### Problema Preparing Boxes
<ProblemPreview url="https://atcoder.jp/contests/abc134/tasks/abc134_d" />
...
De asemenea, numărul total de valori pe care trebuie să le verificăm este $$\mathcal{O}(n \log n)$$, o observație ce este destul de clară pentru oricine a implementat cel puțin o dată ciurul lui Eratostene.
...
## Problema Game
<ProblemPreview url="https://csacademy.com/contest/archive/task/game/statement/" />
