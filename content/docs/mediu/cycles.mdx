...
O secvență de muchii $$(v\_1, v\_2, ..., v\_k, v\_1)$$ formează un **ciclu** dacă
$$(v\_i, v\_{i + 1}) \in E$$ pentru orice $$1 \leq i \< k$$ și $$(v\_k, v\_1) \in E$$.
Un ciclu este **simplu** dacă $$v\_i \neq v\_j$$ pentru orice $$1 \leq i \< j \<
k$$.

Altfel spus, un **ciclu** reprezintă o secvență de muchii ce nu se repetă,
pleacă de la un nod $$v\_1$$ și parcurgând în ordine acele muchii, se ajunge
tot la nodul $$v\_1$$. Un ciclu simplu este un ciclu în care nu se repetă
noduri.
...
1$$ este ușor de tratat, deoarece graful din șir trebuie să aibă doar bucle. În caz contrar, trebuie să verificăm dacă toate ciclurile din componentele conexe create de graful dat au lungime $$k$$.
