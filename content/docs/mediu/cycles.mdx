...
Vom începe prin a relua definiția discutată la articolul anterior [despre grafuri](../usor/graphs.md).
...
Ulterior, în alte probleme precum cele în care avem nevoie de dinamici pe măști, vom discuta aplicații avansate ale acestor cicluri, așa cum sunt prezentate [în acest articol](./bitmask-dp.md#problema-hamiltonian-flights).
