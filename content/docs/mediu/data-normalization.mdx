...
O altă abordare constă în folosirea unei abordări pe stilul [Șmenului lui Mars](../usor/partial-sums.md#smenul-lui-mars), iar pentru fiecare interval, putem adăuga 1 în zona $$[st, dr]$$, iar complexitatea ar deveni $$\mathcal{O}(maxval)$$.
