...
<Callout type="note" title="Cum funcționează analiza amortizată?">
...
- $$\frac{n}{2} + \frac{n}{3} + \frac{n}{5} + \dots$$, sumă care converge la $$\mathcal{O}(n \log \log n)$$, datorită proprietăților sumelor armonice. Se poate observa și când programul este rulat că viteza lui de execuție este foarte bună în practică.
