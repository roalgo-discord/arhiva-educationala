...
Atunci, putem folosi o structură de tip DSU. Vom reține $par_i$ ca "părintele" nodului $i$, sau mai ușor de înțeles, capătul stânga al intervalului în care este nodul $i$. Este nevoie să reținem doar capătul dreapta, deoarece capătul dreapta al secvenței curente este predecesorul capătului stânga al secvenței următoare. Vom reține și $nxt_i$ capătul stânga al secvenței de după secvența în care este $i$.
