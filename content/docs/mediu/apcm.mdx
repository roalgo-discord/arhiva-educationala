...
<Callout type="def">
  Arborele parțial de cost minim (APCM) un graf parțial conex cu proprietatea că suma costurilor muchiilor este minimă și graful este un arbore (deci, are $$n-1$$ muchii).
</Callout>
