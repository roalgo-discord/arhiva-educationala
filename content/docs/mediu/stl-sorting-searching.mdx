...
title: Aplicații ale STL în problemele de căutare și sortare
authors: [stefdasca]
prerequisites:
  - greedy
  - sorting
...
<ProblemPreview url="https://cses.fi/problemset/task/1661" />
...
## Problema Eugene and an array
<ProblemPreview url="https://codeforces.com/contest/1333/problem/C" />
...
## Problema Ramen
<ProblemPreview url="https://kilonova.ro/problems/24" />
