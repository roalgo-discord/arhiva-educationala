---
id: pow-log
title: Aritmetică modulară. Ridicare la putere în timp logaritmic
authors: [stefdasca]
prerequisites:
  - basic-math
  - divisibility
...
Împărțirea este cea mai grea operație de manevrat în cazul operațiilor modulare, recomandăm citirea articolului despre [invers modular](./modular-inverse.mdx) pentru mai multe detalii.
