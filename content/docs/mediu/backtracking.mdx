---
id: backtracking
title: Căutare completă. Tehnica Backtracking
authors: [stefdasca]
prerequisites:
  - functions
  - simulating-solution
...
Această tehnică ne va garanta mereu obținerea unei soluții optime, dar din păcate, rezolvările care folosesc această tehnică tind să fie foarte lente, această metodă fiind o strategie viabilă doar atunci când **datele de intrare și restricțiile sunt foarte mici** (de regulă, $$n \leq 10$$ pentru permutări, $$n
\leq 20$$ pentru submulțimi și doar în cazuri foarte rare și cu multe optimizări, $$n$$ poate fi cel mult $$30-40$$).
...
<ProblemPreview url="https://www.pbinfo.ro/probleme/123/permutari" />
...
<ProblemPreview url="https://cses.fi/problemset/task/1624" />
