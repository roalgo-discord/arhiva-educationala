...
<Callout type="warning">
  A nu se confunda denumirea de parsing cu cea de la parsarea datelor de intrare, chiar dacă ambele se ocupă de procesarea unor șiruri de caractere, parsarea datelor este o metodă folosită pentru îmbunătățirea vitezei de citire a datelor, mai multe detalii puteți găsi [aici](../cppintro/fast-io.mdx).
</Callout>
...
## Problema exemplu - Evaluare
<ProblemPreview url="https://www.infoarena.ro/problema/evaluare" />
...
## Problema mulțimi
<ProblemPreview url="https://kilonova.ro/problems/1539" />
