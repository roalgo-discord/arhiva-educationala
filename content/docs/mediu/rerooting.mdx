---
id: rerooting
title: Tehnica celor două DFS-uri (rerooting)
authors: [stefdasca]
prerequisites:
  - tree-1
  - intro-dp
...
<ProblemPreview url="https://cses.fi/problemset/task/1132" />

<Callout type="info">
  Această problemă are o soluție video explicată chiar de autor, pe care oputeți accesa [aici](https://www.youtube.com/watch?v=DZA4mYWpPno)
</Callout>
...
## Problema Subtree
<ProblemPreview url="https://atcoder.jp/contests/dp/tasks/dp_v" />
