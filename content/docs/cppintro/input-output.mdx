---
id: input-output
title: Citirea și afișarea datelor
...
<Callout type="obs" title="endl vs '\n'">
...
<Callout type="obs" title="Numele fișierelor">
...
<Callout type="obs" title="Citirea unui număr necunoscut de valori">
