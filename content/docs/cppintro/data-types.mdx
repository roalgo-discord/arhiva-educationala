---
id: data-types
title: Variabile și tipuri de date simple
...
<Callout type="note" title="Underflow">
...
<Callout type="note" title="Numere mai mari">
  În unele probleme, chiar și numerele pe 64 (sau 128) de biți nu sunt îndeajuns de mari, așa că se impune păstrarea datelor sub formă de vectori, mai multe detalii despre asta puteți găsi în [acest articol](../mediu/bignum.mdx), după ce vă familiarizați cu lucrul cu algoritmi mai dificili decât scopul acestui articol.
</Callout>
