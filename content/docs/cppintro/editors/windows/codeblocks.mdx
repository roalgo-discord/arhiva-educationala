...
2. Alege `codeblocks-20.03-setup.exe`. Ambele mirror-uri sunt bune, însă recomand Sourceforge. Dacă vrei să ai o instalare portabilă, alege `codeblocks-20.03-nosetup.zip`.
   ...
   <Callout type="warning">
     Nu alege variantele cu MinGW. Acele installere vin cu o versiune învechită de MinGW (vin cu GCC 8.1, mai precis). Pentru cea mai bună experiență, avem nevoie de cel mai nou compilator.
   </Callout>

   [Vezi instrucțiuni aici :material-open-in-new:](./../../compilers/windows/mingw64.mdx)
...
<img alt="" src="./codeblocks/cb.png" width="577" height="407" />
...
<img alt="" src="./codeblocks/cb-1.png" width="543" height="277" />
...
<img alt="" src="./codeblocks/cb-interfata.png" width="1806" height="925" />
...
<img alt="" src="./codeblocks/cb-new-project.png" width="594" height="458" />
...
<img alt="" src="./codeblocks/image.png" width="526" height="511" />

Apasă Next.

4. De aici, alege C++ (este o introducere de C++, la urma urmei) și apasă Next.
   <img alt="" src="./codeblocks/image-1.png" width="526" height="511" />

5. Aici este pasul unde alegi titlul proiectului, precum și folderul proiectului.

   <img alt="" src="./codeblocks/image-3.png" width="526" height="511" />
   ...
   <img alt="" src="./codeblocks/image-4.png" width="526" height="511" />
...
<img alt="" src="./codeblocks/image-5.png" width="526" height="511" />

Dacă ai făcut totul corect, fereastra ta ar trebui să arate astfel:

<img alt="" src="./codeblocks/image-6.png" width="1806" height="925" />
...
<img alt="" src="./codeblocks/image-7.png" width="1115" height="628" />
...
3. Bifează și "Ensure consistent EOLs", ca să nu se amestece sfârșiturile de linii.
   ...
   <img alt="" src="./codeblocks/image-8.png" width="788" height="675" />
...
2. Descarcă următorul fișier de configurare (care este exact cel de pe site, însă prezervat pentru conveniența cititorului):
   ...
   [colour\_themes.conf :material-download:](./codeblocks/colour_themes.conf)
...
7. În partea stângă, bifează tot din listă. Asigură-te că fereastra ta arată așa:
   ...
   <img alt="" src="./codeblocks/image-9.png" width="668" height="437" />
...
<img alt="" src="./codeblocks/image-10.png" width="1806" height="925" />
...
- În Settings > Editor > Keyboard shortcuts, mergem la Edit, apoi la Toggle comment și adăugăm scurtătura ++ctrl+slash++. Practic ne scutește din a ține minte ++ctrl+shift+c++ și ++ctrl+shift+x++;
...
2. Selectăm "Closes whitespace in the angle brackets of template definitions". Pe vremuri, din cauza unui defect în standard și în compilatoare, nu puteai scrie asta:
   ...
   Acum toate compilatoarele au evoluat, deci este sigur să activezi opțiunea asta. De asemenea, activează "Enable line breaking". Acest lucru garantează faptul că o linie va fi împărțită dacă trece de o lungime anume. Eu setez valoarea la 80 de obicei, însă 120 este acceptabil dacă ai mai mult spațiu orizontal.
