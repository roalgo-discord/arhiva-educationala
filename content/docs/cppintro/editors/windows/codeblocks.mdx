...
- Pentru a crea un fișier _gol_, apasă ++ctrl+shift+n++ (File > New > Empty file);
...
Acel `#!cpp return 1;` nu este asociat cu linia de dinaintea ei sau cu `if`, deci este un dezastru care o să se întâmple la un moment dat. Prin adăugarea acoladelor, suntem expliciți, și este mai ușor de extins codul.
