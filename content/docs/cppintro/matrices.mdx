...
!!! example "Exemplu de parcurgere și afișare" `cpp     --8<-- "cppintro/matrices/matrices04.cpp"`
...
`mat[n][m]`. Pentru a fi expliciți, folosim `randuri` și `coloane` în
acest articol.
...
De exemplu, `int v[101][101][101];` reprezintă un "cub" de dimensiuni 101 × 101 × 101. La fel ca la celelalte tablouri, cu cât avem mai multe dimensiuni, cu atât cantitatea de memorie crește, iar în cele mai multe cazuri, nu vom avea nevoie de mai mult de 3–4 dimensiuni.
