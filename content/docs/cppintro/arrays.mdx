...
De exemplu, `#!cpp int v[101];` înseamnă ca am declarat un tablou cu 101 elemente, pozițiile fiind numărate de la 0 la 100.
...
Pentru a atribui o valoare unei anumite poziții, se va proceda similar ca la o variabilă obișnuită, de exemplu `#!cpp v[5] = 7;` înseamnă că pe poziția 5, vom avea acum valoarea 7.
...
O altă metodă de a inițializa elementele dintr-un tablou este aceea de a atribui valori primelor poziții, idee ce va fi folosită pe parcurs la diverși algoritmi, un exemplu notabil fiind flood fill. De exemplu, `#!cpp int A[] = {10, 20, 30};` va crea un tablou cu 3 elemente, unde `#!cpp A[0] = 10; A[1] = 20;` ș.a.m.d.
...
Pentru mai multe detalii, recomandăm citirea articolului pe acest subiect, pe care îl puteți găsi [aici](../usor/sorting.md).
