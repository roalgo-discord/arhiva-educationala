---
id: dirichlet
title: Principiul lui Dirichlet (principiul cutiei)
authors: [stefdasca]
prerequisites:
  - basic-math
tags:
...
<ProblemPreview url="https://kilonova.ro/problems/3271" />
...
## Problema 2 - Subsecv
<ProblemPreview url="https://www.pbinfo.ro/probleme/1262/subsecv" />
...
Recomandăm de asemenea urmărirea materialelor din resursele suplimentare, chiar dacă unele dintre acestea sunt mai degrabă orientate spre olimpiada de matematică, deoarece fac unele aplicații mai dificile mai ușor de rezolvat.
...
- [Principiul Dirichlet - Math.mdx](https://www.math.mdx/school/competitiva/dirichlet/dirich.html)
