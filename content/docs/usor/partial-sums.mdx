...
![](../images/sumepartiale/sp1light.svg#only-light) ![](../images/sumepartiale/sp1dark.svg#only-dark)

Apoi, va trebui să scădem prefixul $1, 2, \dots, st - 1$. ![](../images/sumepartiale/sp2light.svg#only-light) ![](../images/sumepartiale/sp2dark.svg#only-dark)

În final, subsecvența $st, st + 1, \dots, dr - 1, dr$ va fi alcătuită din acele poziții care se află în segmentul _mov_, dar nu în segmentul _roșiatic_ ($1, 2,
...
De asemenea, sumele parțiale se pot extinde și pe tablouri bidimensionale. Să presupunem că lucrăm cu matricea $A$ care are $N$ linii și $M$ coloane. Vom defini _matricea_ $sp$ în felul următor: $sp[i][j]$ reprezintă suma valorilor aflate în submatricea care are colțul stânga-sus de coordonate $(1, 1)$ și colțul dreapta-jos de coordonate $(i, j)$.

Astfel, putem scrie:

\[ sp[i][j] = \sum*{x=1}^{i} \sum*{y=1}^{j} a[x][y] \]
...
![](../images/sumepartiale/sp3light.svg#only-light) ![](../images/sumepartiale/sp3dark.svg#only-dark)
...
![](../images/sumepartiale/sp4light.svg#only-light) ![](../images/sumepartiale/sp4dark.svg#only-dark)

$suma = sp[x][y] - sp[x][z - 1]$

Asemenea cazului precedent este si cazul în care noi dorim să aflăm suma unei submatrice care are colțurile $(z, 1)$ și $(x, y)$. Similar, $sp[x][y]$ nu este suficient, dar este un punct de plecare. Față de cazul precedent, submatricea _în plus_ este cea determinată de colțurile $(1, 1)$ și $(z - 1, y)$. În final, formula pentru acest caz va fi $sp[x][y] - sp[z - 1][y]$.

![](../images/sumepartiale/sp5light.svg#only-light) ![](../images/sumepartiale/sp5dark.svg#only-dark)
...
![](../images/sumepartiale/sp6light.svg#only-light) ![](../images/sumepartiale/sp6dark.svg#only-dark)
...
![](../images/sumepartiale/sp7light.svg#only-light) ![](../images/sumepartiale/sp7dark.svg#only-dark)
...
![](../images/sumepartiale/sp8light.svg#only-light) ![](../images/sumepartiale/sp8dark.svg#only-dark)
