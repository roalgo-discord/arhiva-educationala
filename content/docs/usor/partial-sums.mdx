---
id: partial-sums
title: Sume parțiale. Șmenul lui Mars
authors: [ivan]
prerequisites:
  - arrays
  - matrices
...
Faptul că răspunsul nostru este dat de o formulă, va face ca timpul nostru efectuat pentru rezolvarea unei întrebări să fie constant $$\mathcal{O}(1)$$, ceea ce va duce ca programul nostru să aibă o complexitate finală $$\mathcal{O}(N + Q)$$, pentru calcularea tabloului $$sp$$ și pentru citirea și răspunderea la întrebări. Totuși, hai să vedem de ce formula menționată mai sus funcționează.
...
unde vectorul $$\mathrm{mars}\[]$$ reprezintă adunările/scăderile din șmen. Așa cum am zis și mai sus, noi calculăm valorile noastre din șir ca la sumele parțiale, deci, se poate afirma că: $$v\[i] = \mathrm{mars}\[1] + \mathrm{mars}\[2] + \dots + \mathrm{mars}\[i]$$
