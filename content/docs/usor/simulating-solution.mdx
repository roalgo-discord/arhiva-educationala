...
De exemplu, pentru $$N=8$$, aplicând de $$N$$ ori regula $$A$$ se obțin șirurile: <img alt="" src="../images/simulation/asort-imagine.png" width="1022" height="466" />
...
### Problema Robinson
<ProblemPreview url="https://kilonova.ro/problems/1221" />

Mai intai, vom construi matricea in modul descris. Dupa aceea, va trebuie sa simulam drumul din problema. Pentru a afla usor urmatoarea pozitie, vom folosi [vectori de directie](../mediu/lee.mdx#vectorii-de-directie). După ce aflăm directța în care mergem, vom marca poziția ca vizitată (adică setăm valoarea din matrice la $$VISITED$$, o constantă care va fi egală cu $$-1$$ sau cu orice valoare care nu poate apărea in matrice).

De asemenea, pentru a determina ușor dacă am ieșit sau nu din matrice, vom [borda matricea](../mediu/lee.mdx#evitarea-accesarii-unor-patrate-din-afara-matricii) cu valoarea $$VISITED$$.
...
### Problema Furnica
<ProblemPreview url="https://kilonova.ro/problems/763" />

În această problemă este destul de direct ce trebuie să facem. Vom simula procesul descris, ținând o matrice $$fr\_{i, j}$$ care va reprezenta de câte ori am trecut printr-o anumită poziție $$(i, j)$$. De asemenea, și în această problemă vom folosi vectori de direcție pentru a afla ușor următoarea poziție.
