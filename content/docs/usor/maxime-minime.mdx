...
Pentru a extinde problema la $k$ valori, va fi necesară cunoașterea [vectorilor](../cppintro/arrays.md), ceea ce face această aplicație mai dificilă. Astfel, vom proceda la fel ca la cazul precedent, dar vom ține cele mai mari/mici $k$ valori într-un vector și vom efectua modificările în mod corespunzător.
