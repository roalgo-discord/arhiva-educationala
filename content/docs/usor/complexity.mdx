...
- tipul `int`: 4 octeți, limite între $-2^{31}$ si $2^{31} - 1$ ($-2 \ 147
  \ 483 \ 648$ si $2 \ 147 \ 483 \ 647$).
- tipul `short`: 2 octeți, limite între $-2^{15}$ si $2^{15} - 1$ ($-32 \
  768$ si $32 \ 767$).
- tipul `char`: 1 octet, limite între $-128$ si 127.
- tipul `bool`: 1 octet, accepta doar 0 sau 1.
- tipul `long long`: 8 octeți, limite între $-2^{63}$ si $2^{63} - 1$ ($-9
  \ 223 \ 372 \ 036 \ 854 \ 775 \ 808$ si $9 \ 223 \ 372 \ 036 \ 854 \ 775 \
  807$) — numere de maxim 19 cifre.
...
De exemplu, dacă avem un vector de $10^6$ elemente de tipul `int` și altul de $10^5$ elemente de tipul `long long`, vom folosi $4 \cdot 10^6 + 8
