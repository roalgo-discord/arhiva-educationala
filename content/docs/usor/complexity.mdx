...
- tipul `#!cpp double`: 8 octeți, limite între aproximativ $-10^{208}$ și $10^{208}$.
- tipul `#!cpp long double`: în funcție de standardul de compilare, cel puțin 8 octeți, limite mai mari decât cele de la `#!cpp double`.

De exemplu, dacă avem un vector de $10^6$ elemente de tipul `#!cpp int` și altul de $10^5$ elemente de tipul `#!cpp long long`, vom folosi $4 \cdot 10^6 + 8
