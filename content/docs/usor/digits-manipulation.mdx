...
<Callout type="def" title="Ultima cifră">
...
<Callout type="info" title="A $$k$$-a cifră de la coadă">
  Pentru a afla cea de-a $$k$$-a cifră de la coadă a unui număr natural $$x$$, vom folosi formula $$\frac{x}{10^{k-1}} \%\ 10$$ sau, cum am scrie în limbajul C/C++, `(x/p) % 10`.
</Callout>
...
## Problema Suma cifrelor unui număr
<ProblemPreview url="https://www.pbinfo.ro/probleme/10/suma-cifrelor" />
...
## Problema Control
<ProblemPreview url="https://www.pbinfo.ro/probleme/340/control" />
...
<Callout type="def" title="Cifra de control">
...
<Tabs items={["Simularea răspunsului", "Formula simplificată"]}>
<Tab value="Simularea răspunsului">
```cpp
#include <iostream>
using namespace std;
...
<Tab value="Formula simplificată">
```cpp
#include <iostream>
using namespace std;
...
### Problema Oglinditul unui număr
<ProblemPreview url="https://www.pbinfo.ro/probleme/69/oglindit" />

<Callout type="def" title="Oglinditul unui număr">
...
<Callout type="def" title="Numere palindrom">
...
## Problema Aparitii2
<ProblemPreview url="https://www.pbinfo.ro/probleme/108/aparitii2" />
