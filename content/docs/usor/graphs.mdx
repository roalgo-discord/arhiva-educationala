---
id: graphs
title: Introducere în teoria grafurilor
...
<Callout type="def" title="Noțiunea de graf">
...
<Callout type="def" title="Graf orientat și neorientat">
  Un **graf neorientat** $$G = (V, E)$$ este un graf în care perechile de
  vârfuri $$(u, v) \in E$$ sunt neordonate. Aceasta înseamnă că, dacă $$(u, v)\in E$$ este o muchie de la $$u$$ la $$v$$, atunci și $$(v, u) \in E$$.
</Callout>

<Callout type="def" title="Graf orientat">
...
<Callout type="def" title="Noduri adiacente">
...
<Callout type="def" title="Incidență">
...
<Callout type="def" title="Gradul unui nod">
...
- **Gradul intern** (numărul de muchii care intră în nodul $$v$$), notat $$\deg^-(v)$$: $$ \deg^-(v) = |\{(u, v) \in E \mid u \in V\}|$$

- **Gradul extern** (numărul de muchii care ies din nodul $$v$$), notat $$\deg^+(v)$$: $$ \deg^+(v) = |\{(v, u) \in E \mid u \in V\}|$$
...
<Callout type="def" title="Lungimea unui lanț">
...
<Callout type="def" title="Graf parțial și subgraf">
...
<Callout type="def" title="Subgraf">
  ...
  graf unde $$V' \subseteq V$$ și $$E' \subseteq \{(u, v) \in E \mid u, v \in V'\}$$.
</Callout>

<Callout type="obs" title="Observație">
...
<Callout type="def" title="Graf complet $$K_n$$">
...
<Callout type="def" title="Graf bipartit">
...
<Callout type="def" title="Graf planar">
...
<Callout type="def" title="Graf regulat">
...
<img alt="" src="/images/grafuri/graf-dark.svg" width="422" height="414" />
...
<Callout type="def" title="Matrice de adiacență">
...
<img alt="" src="/images/grafuri/matrice-dark.svg" width="201" height="210" />

<Callout type="def" title="Listă de vecini">
...
<Callout type="example" title="Exemplu">
...
<Callout type="def" title="Graf conex">
...
<Callout type="def" title="Componenta conexă">
...
<Callout type="info" title="Parcurgerea în adâncime (DFS)">
...
<ProblemPreview url="https://kilonova.ro/problems/2036" />
...
<Callout type="def" title="Drum minim">
...
<Callout type="info" title="Parcurgerea în lățime (BFS)">
...
<ProblemPreview url="https://kilonova.ro/problems/2037" />
...
## Problema grarb
<ProblemPreview url="https://www.infoarena.ro/problema/grarb" />
...
Această problemă se împarte în două subprobleme relativ ușor de identificat - aflarea componentelor conexe ale grafului (dacă avem $$C$$ componente conexe, va fi nevoie de $$C - 1$$ muchii pentru a transforma graful într-unul conex), precum și aflarea numărului de muchii care trebuie scoase pentru a transforma graful în arbore (la final, trebuie să ne rămână $$N-1$$ muchii). Astfel, vom avea nevoie de $$C - 1$$ muchii noi și va trebui să scoatem $$M + C - 1 - (N - 1)$$ = $$M + C - N$$ muchii pentru a avea un arbore.
...
## Problema graf
<ProblemPreview url="https://kilonova.ro/problems/49" />
...
<ProblemPreview url="https://cses.fi/problemset/task/1669/" />
