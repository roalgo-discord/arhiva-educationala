...
Deoarece valorile din șir sunt destul de mari, trebuie să [normalizăm datele](../mediu/data-normalization.md), iar mai apoi să folosim AIB pentru a rezolva problema.
...
Pentru a căuta binar în AIB în $\mathcal{O}(\log n)$, vom folosi o tehnică similară cu [căutarea binară pe biți](../usor/binary-search.md#cautarea-binara-a-lui-mihai-patrascu), verificând dacă adăugarea a $2^k$ poziții în AIB ne-ar duce peste valoarea cerută sau nu.
