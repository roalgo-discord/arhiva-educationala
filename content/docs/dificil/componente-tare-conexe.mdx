...
<Callout type="info" title="Graf transpus">
...
<Callout type="info" title="Compresarea componentelor tare conexe">
...
## Problema Coin Collector
<ProblemPreview url="https://cses.fi/problemset/task/1686/" />
