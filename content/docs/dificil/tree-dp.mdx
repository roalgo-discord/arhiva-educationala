---
id: tree-dp
title: "Programare dinamică pe arbore"
authors: [stefdasca]
prerequisites:
  - tree-1
  - intro-dp
...
<ProblemPreview url="https://cses.fi/problemset/task/1130/" />
...
În mod similar, pentru a defini $$dp\[1]\[i]$$, vom vrea să cuplăm nodul $$i$$ cu unul din fiii săi, iar mai apoi să preluăm toate maximele de la celelalte noduri. Astfel, $$dp\[1]\[i]$$ va fi egal cu $$\max (1 + dp\[0]\[x]+ \sum \max(dp\[0]\[x\_0], dp\[1]\[x\_0]))$$, unde $$x$$ este fiul ales, iar $$x\_0$$ reprezintă oricare din ceilalți fii ai nodului $$i$$.
...
<ProblemPreview url="https://codeforces.com/problemset/problem/1083/A" />
...
## Problema Arbore
<ProblemPreview url="https://kilonova.ro/problems/188" />
...
## Problema Museum
<ProblemPreview url="https://oj.uz/problem/view/CEOI17_museum" />
...
## Problema TreeGCD
<ProblemPreview url="https://kilonova.ro/problems/11" />
...
<ProblemPreview url="https://codeforces.com/problemset/problem/1901/E" />
