...
<Callout type="example">
  ...
  - `query(x, y)` - aflați suma elementelor din intervalul $$\[x, y]$$, $$A\_{st} - A\_{st+1} + ... + A\_{dr}$$
</Callout>
...
- Înălțimea maximă a unui arbore binar complet cu $$N$$ frunze este $$\lceil \log\_2(N) \rceil$$.
