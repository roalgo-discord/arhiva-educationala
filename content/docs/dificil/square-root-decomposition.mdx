...
title: "Descompuneri în bucăți de radical (Square Root Decomposition)"
authors: [stefdasca]
prerequisites:
  - arrays
  - partial-sums
...
<ProblemPreview url="https://cses.fi/problemset/task/1648" />
...
### Problema Consecutive Max Difference
<ProblemPreview url="https://csacademy.com/contest/interview-archive/task/consecutive-max-difference/" />
...
- Dacă avem două (sau mai multe) query-uri din același bucket, capătul din stânga se va mișca cu cel mult $$\sqrt n$$, iar numărul total de pași pe care îi facem la dreapta este de $$n$$. Deoarece numărul de bucket-uri este $$\mathcal{O}(\sqrt n)$$, atunci contribuția la complexitate de la aceste query-uri este $$\mathcal{O}(n \sqrt  n)$$.
...
### Problema fsecv
<ProblemPreview url="https://kilonova.ro/problems/1814" />
...
### Problema Jumpsum
<ProblemPreview url="https://kilonova.ro/problems/481" />
...
### Problema Bvarcolaci
<ProblemPreview url="https://kilonova.ro/problems/171" />
