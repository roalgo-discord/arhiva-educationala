---
id: rmq
title: "Sparse Table. Binary Lifting. Range Minimum Query (RMQ)"
authors: [traian]
prerequisites:
  - matrices
  - partial-sums
...
<Callout type="obs">
  [LCA](./lowest-common-ancestor.mdx) este calculat, de asemenea, folosind binary lifting. Căutarea binară în [AIB](./fenwick-tree.mdx) folosește, de asemenea, binary lifting.
</Callout>
...
### Problema excursie
<ProblemPreview url="https://kilonova.ro/problems/619" />
...
<ProblemPreview url="https://codeforces.com/contest/2009/problem/G2" />

#### Versiunea ușoară
<ProblemPreview url="https://codeforces.com/contest/2009/problem/G1" />
...
<Callout type="obs">
  Această soluție este foarte asemănătoare cu soluția la problema [strămoși](https://infoarena.ro/problema/stramosi), discutată în articolul de [LCA](./lowest-common-ancestor.mdx#binary-lifting)
</Callout>
