---
id: problemsetting
title: "Cum propui și pregătești o problemă?"
authors: [stefdasca]
prerequisites:
  - debugging
tags:
...
<Callout type="tip" title="Tutorial Polygon">
  Recomandăm citirea [acestui blog](https://kilonova.ro/posts/polygon-guide-415-bot7ke) pentru o introducere scurtă, sau a [acestuia](https://quangloc99.github.io/posts/polygon-codeforces-tutorial/) pentru ceva mai cuprinzător.
</Callout>
...
Pentru a apela un generator numit gen, trebuie să folosim instrucțiuni de tipul $$gen \ par\_1 \ par\_2 \dots \ par\_k$$ > \$$\$$.
