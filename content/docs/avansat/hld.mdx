...
Se dă un arbore cu $$N$$ noduri, fiecare având asociată o valoare $$v\_i$$, $$1 \leq i
\leq N$$. Se dau $$M$$ operații de forma $$(t, x, y)$$, cu următoarea semnificație:

- dacă $$t$$ este 0, operația este de tipul update, iar valoarea $$v\_x$$ asociata nodului cu indicele $$x$$ devine $$y$$;
