...
Pentru operația de tip query, va trebuie să parcurgem mai multe lanțuri până când vom ajunge cu cele două noduri în același lanț. Această operațiune este chiar cea de la [Lowest common ancestor (LCA)](../dificil/lowest-common-ancestor.md).
...
Această problemă necesită cunoștințe de la [string hashing](../mediu/hashing.md), respectiv [Lowest common ancestor (LCA)](../dificil/lowest-common-ancestor.md).
